...
var topics = ['cat', 'dog', 'hamster', 'goldfish', 'frog', 'snail', 'turtle', 'rabbit', 'monkey', 'skunk', 'bird', 'squirrel', 'hedgehog', 'ferret', 'zebra', 'lion', 'eagle', 'rhino', 'elephant', 'butterfly'];
...
$( document ).ready(function(){
	...
	function renderButtons(){ 
		...
		for (var i = 0; i < topics.length; i++){
		    ...
		    animalButton.attr('data-name', topics[i]); // Added a data-attribute
		    animalButton.text(topics[i]); // Provided the initial button text
